			...
			<div class="sidebar-inner">
				<div class="sidebar-logo">
					<div class="peers ai-c fxw-nw">
						<div class="peer peer-greed">
							<a class="sidebar-link td-n" href="<?=$admin_url ?>dashboard">
								<div class="peers ai-c fxw-nw">
									<div class="peer">
										<div class="logo">
											<img src="assets/static/images/logo.png" alt="" style="height: 50px; width: 50; margin-left: 7px;">
										</div>
									</div>
									<div class="peer peer-greed">
										<h5 class="lh-1 mB-0 logo-text">Ubet</h5>
									</div>
								</div>
							</a>
						</div>
				...
				<ul class="sidebar-menu scrollable pos-r">
					<li class="nav-item mT-30 actived">
						<a class="sidebar-link" href="<?=$admin_url ?>dashboard">
					...
					<li class="nav-item">
						<a class="sidebar-link" href="penyalur">
							<span class="icon-holder">
								<i class="c-brown-500 ti-user"></i>
							</span>
							<span class="title">Penyalur</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="sidebar-link" href="keahlian">
							<span class="icon-holder">
								<i class="c-brown-500 ti-clipboard"></i>
							</span>
							<span class="title">Keahlian</span>
						</a>
					</li>
				...
				<div class="header-container">
					...
					<li class="dropdown">
						<a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
							...
							<div class="peer">
								<span class="fsz-sm c-grey-900"><?=$_SESSION['adm_name']?></span>
							</div>
						</a>
