<main class="main-content bgc-grey-100">
	<div id="mainContent">
		<div class="container-fluid">
			<h4 class="c-grey-900 mT-10 mB-30">Data Provinsi</h4>
			<div class="row">
				<div class="col-md-12">
...
<!-- Insert Design Modal -->
              ...
              <form method="POST" id="ins_rec">
                <div class="modal-body">
                  <div class="form-group">
                  	...
                  	<input type="number" name="id_prov" class="form-control" placeholder="ID Provinsi">
                  	<span class="error-msg" id="msg_1"></span>
                  </div>
                  <div class="form-group">
                  	<label><b>Nama Provinsi</b></label>
                  	<input type="text" name="name_prov" class="form-control" placeholder="Nama Provinsi">
          ...
          <div class="modal-content">
            ...
            <form method="POST" id="updata">
              <div class="modal-body">
                <div class="form-group">
                  <label><b>Nama Provinsi</b></label>
                  <input type="text" class="form-control" name="u_name_prov" id="upd_1" placeholder="Nama Provinsi">
    ...
    $('#tbl_rec').load('<?php echo $admin_url ?>model/daerah/provinsi/v.php');
    ...
    $('#ins_rec').on("submit", function(e){
      ...
      $.ajax({
        ...
        type:'POST',
        url:'<?php echo $admin_url ?>controller/daerah/prov_control.php',
        data:$(this).serialize(),
    ...
    $(document).on("click", "button.editdata", function(){
      ...
      $.getJSON("<?php echo $admin_url ?>controller/daerah/prov_control.php", {checkid : check_id}, function(json){
       if(json.status == 0){
        $('#upd_1').val(json.nmProv);
        $('#upd_2').val(check_id);
      }
      else{
        console.log(json.msg);
