<main class="main-content bgc-grey-100">
	<div id="mainContent">
		<div class="container-fluid">
			<h4 class="c-grey-900 mT-10 mB-30">Data Keahlian</h4>
			<div class="row">
				<div class="col-md-12">
              ...
              <form method="POST" id="ins_rec">
                <div class="modal-body">
                  <div class="form-group">
                  	<label><b>ID Keahlian</b></label>
                  	<input type="number" name="idKeahlian" class="form-control" placeholder="ID Keahlian">
                  	<span class="error-msg" id="msg_1"></span>
                  </div>
                  <div class="form-group">
                  	<label><b>Nama Keahlian</b></label>
                  	<input type="text" name="namaKeahlian" class="form-control" placeholder="Nama Keahlian">
          ...
          <div class="modal-content">
            ...
            <form method="POST" id="updata">
              <div class="modal-body">
                <div class="form-group">
                  <label><b>Nama Keahlian</b></label>
                  <input type="text" class="form-control" name="u_nama_keahlian" id="upd_1" placeholder="Nama Keahlian">
                  <span class="error-msg" id="umsg_1"></span>
                </div>
                <div class="form-group">
                  <input type="hidden" name="dataval" id="upd_2">
...
$(document).ready(function (){
    ...
    $('#tbl_rec').load('<?php echo $admin_url ?>model/keahlian/v.php');
    ...
    $('#ins_rec').on("submit", function(e){
      ...
      $.ajax({
        ...
        type:'POST',
        url:'<?php echo $admin_url ?>controller/keahlian_control.php',
        data:$(this).serialize(),
    ...
    $(document).on("click", "button.editdata", function(){
      ...
      $.getJSON("<?php echo $admin_url ?>controller/keahlian_control.php", {checkid : check_id}, function(json){
       if(json.status == 0){
        $('#upd_1').val(json.nmKeahlian);
        $('#upd_2').val(check_id);
      }
      else{
        console.log(json.msg);
